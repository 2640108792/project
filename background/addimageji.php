...
include "config.php";
$miaoshu=$_POST['text'];
$dizhi1="images/ji/".$_FILES["file"]["name"];
$dizhi2="../images/ji/".$_FILES["file"]["name"];
...
if (file_exists("../images/ji/" . $_FILES["file"]["name"]))
{   $sql="insert into jlimg (src,user_text) VALUES ('$dizhi1','$miaoshu')";
    $my= $pdo->exec($sql);
