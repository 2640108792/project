...
include "config.php";
$miaoshu=$_POST['text'];
$dizhi1="images/hei/".$_FILES["file"]["name"];
$dizhi2="../images/hei/".$_FILES["file"]["name"];
...
if (file_exists("../images/hei/" . $_FILES["file"]["name"]))
{   $sql="insert into hljimg (src,user_text) VALUES ('$dizhi1','$miaoshu')";
    $my= $pdo->exec($sql);
