...
$sql1="select count(*) as value from mess WHERE types='2'";//留言数目
$smt1=$pdo->prepare($sql1);
$smt1->execute();
$tot=$smt1->fetchColumn();
//留言内容
$sql2="SELECT t_users.user_name,t_users.head,mess.utext,mess.updatetime FROM mess,t_users WHERE mess.user_account=t_users.user_account and mess.types=2";
$smt2=$pdo->query($sql2);
...
<div class="single">
    <div class="container">
        <div id="biaoti" ><img src="images/j.jpg" ></div>
        <ul class="accordion">
            <?php
            foreach($rows as $rw){
                echo " <li>
        ...
        if (isset($_SESSION["admin"]) && $_SESSION["admin"] === true){
            ...
            <div class=\"leave-comment wow fadeInUp\" data-wow-duration=\"1000ms\" data-wow-delay=\"300ms\">
                 ...
                 <form action=\"ji.php\" method=\"post\">
